#############################################################################
# Makefile for building: vipcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ?? 31 10:09:26 2016
# Project:  vipcoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_UPNP=- -o Makefile vipcoin-qt.pro
#############################################################################
...
Makefile: vipcoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile vipcoin-qt.pro
